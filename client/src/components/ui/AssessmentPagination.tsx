            ...
            <PaginationContent>
                ...
                <PaginationItem className="bg-transparent text-gray-200 rounded-lg hover:bg-gray-600 hover:text-white transition-colors">
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-600 hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                {getVisiblePages().map((page, index) => (
                    <PaginationItem key={index} className="bg-transparent text-gray-200 rounded-lg hover:bg-gray-600 hover:text-white transition-colors">
                        {page === '...' ? (
                            <PaginationEllipsis />
                        ) : (
                            <button

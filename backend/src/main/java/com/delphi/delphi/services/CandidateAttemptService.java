...
public class CandidateAttemptService {
    ...
    public CandidateAttempt createCandidateAttempt(CandidateAttempt candidateAttempt) {
        // Validate that the associated candidate and assessment exist
        if (candidateAttempt.getCandidate() != null && candidateAttempt.getCandidate().getId() != null) {
            Candidate candidate = candidateService.getCandidateByIdOrThrow(candidateAttempt.getCandidate().getId());
            candidateAttempt.setCandidate(candidate);
        }
        
        if (candidateAttempt.getAssessment() != null && candidateAttempt.getAssessment().getId() != null) {
            Assessment assessment = assessmentService.getAssessmentByIdOrThrow(candidateAttempt.getAssessment().getId());
    ...
    @Transactional(readOnly = true)
    public Page<CandidateAttempt> getAttemptsByCandidateAndStatus(Long candidateId, AttemptStatus status, Pageable pageable) {
    ...
    @Transactional(readOnly = true)
    public Page<CandidateAttempt> getAttemptsByAssessmentAndStatus(Long assessmentId, AttemptStatus status, Pageable pageable) {
    ...
    @Transactional(readOnly = true)
    public Page<CandidateAttempt> getAttemptsCreatedBetween(LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
    ...
    @Transactional(readOnly = true)
    public Page<CandidateAttempt> getAttemptsStartedBetween(LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
    ...
    // Start attempt
    public CandidateAttempt startAttempt(Long id) {

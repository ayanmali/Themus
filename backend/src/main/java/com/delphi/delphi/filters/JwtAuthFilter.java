...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(JwtService jwtService, UserDetailsService userDetailsService, @Value("${app.env}") String appEnv) {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        if (requestPath.equals("/") || requestPath.startsWith("/actuator/") || requestPath.startsWith("/api/auth/") || requestPath.startsWith("/api/recordings")
                || requestPath.startsWith("/api/users/github/callback")
                || requestPath.startsWith("/api/attempts/live")) {
